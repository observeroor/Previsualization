...
def Scene_extraction():
    ...
    sysprompt = """
                ...
                前景人物身体要点：突出描写当前人物行为、身体姿势中最有性张力的部分，如短裙底下暴露的阴户等
                ...
                前景人物身体细节：描述身体没有穿着服装的裸露部位；如果是裸露则要强调裸露状态，如果不是裸露则直接描述服装[一定要判断身体部位是否裸露，如果裸露则要强调裸露，并且突出性张力、性暗示地描写裸露的部位，身体部位参考顺序：躯干、颈部、胸部、背部，屁股、阴部、胳膊、手、大腿、小腿]
