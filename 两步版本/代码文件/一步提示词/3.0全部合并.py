...
# 定义路径
folder1 = os.path.join("两步版本", "过程文件", "nygs", "5.1提示词","1.0分镜提取")
folder2 = os.path.join("两步版本", "过程文件", "nygs" ,"5.1提示词","2.0提示词构成")
folder3 = os.path.join("两步版本", "过程文件", "nygs", "5.1提示词","2.1姿势描述")
folder4 = os.path.join("两步版本", "过程文件", "nygs", "5.1提示词","2.2背景构成")
output_folder = os.path.join("两步版本", "过程文件", "nygs", "5.1提示词","3.0合并")

# 执行合并
merge_json_files(folder1, folder2, output_folder)
merge_json_files(output_folder, folder3, output_folder)
merge_json_files(output_folder, folder4, output_folder)