...
优秀的Stable Diffusion prompts在语法上由一组一组的短语构成,可以参照例子：
焦点内容的例子:(sexy 20 year old girl taking in a giant penis, skimpy sexy clothes, showing lots of skin:1.3) 
女人1头部脸部：(aqua eyes, blonde hair, blush, eyelashes, hair ornament, heart, heart-shaped pupils, heart background, heart hair ornament, long hair, looking at viewer, one side up, open mouth:1.1)
{
    "XX-XX(场景编号)":{
...
会用一句视觉化的句子描述出当前场景中女性人物的行为动作，并突出画面的焦点（主要是具有性行为、性张力的地方）。
在描述出当前场景中女性人物的行为动作时，也可能是以旁观者的眼睛的视角来描述当前场景中女性人物与男性人物的互动，也可能是以当前场景中男性人物眼睛的视角来描述当前场景中女性人物的样子。
在句子会用lady称呼女性，而不是提及名字（因为Stable Diffusion无法识别名字）中。
句子会在"a lady"后面跟随一个括号，括号内是对女性人物的细致描述，包括头部脸部、身体特征、身体部位，这些内容可以直接来源于json文档中对应场景的"女人1头发脸部""女人1身体特征""女人1身体部位"
如果是以旁观者的眼睛的视角来描述当前场景中女性人物与男性人物的互动，那么句子会以man来称呼男性角色，而不提及名字，同时会在"a man"后面跟随一个括号，括号内是，简短描述，不超过10个单词。
