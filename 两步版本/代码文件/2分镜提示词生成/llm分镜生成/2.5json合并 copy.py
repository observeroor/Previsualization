...
# 定义路径
folder1 = os.path.join("两步版本", "过程文件", "nygs", "6th提示词", "2.0背景细节")
folder2 = os.path.join("两步版本", "过程文件", "nygs", "6th提示词", "1.5中景转化")
output_folder = os.path.join("两步版本", "过程文件", "nygs", "6th提示词","2.5合并")
