...
第二步是对人物进行逐一细致描述（先描述女性角色），首先描述人物的肤色、体型，随后按身体部位逐步描述，在描述身体部位时在参考顺序的基础之上，灵活合并描述或者细化描述，在描述时直接输出描述内容，按照“描述内容”，不按照“部位：描述内容”的格式。
...
第二步中必须注意增强3：要描述出每个部位的服装、状态、动作，服装描述要包括服装设计、穿着状态（eg：粉色丝绸上衣半脱到胸部、黑色网状蕾丝丝袜褪到膝盖被淫液沾湿），如果没有服装，就要描述裸露的部位和皮肤状态（eg：光洁丰满的屁股裸露）。
第二步中必须注意增强3：用带有视觉感官的形容词来修饰身体部位、服装，女性人物要突出性张力和美感，要使用光线、色泽等修饰身体部位、服装，来体现出场景的氛围。
在描绘中必须注意：只采取视觉化描述，不能有任何的情感、心理、声音、气味等描述和抽象概念；描述只用包含内容，不包含name
输出格式请返回json格式,原文件提供了多少场景就输出多少场景，不要重复输出也不要遗漏输出， "XX-XX(场景编号)"前缩进为四个空格，（括号内是内容提示词，不用出现在输出结果中）：
{
    "XX-XX(场景编号)":{
        "主体":"（全部人物相对位置和姿势）",
        "画面视角焦距":"(画面的视角),(画面焦距)",
        "细致描述":"(人物1身体特征和服装),(身体部位描述),(身体部位描述1),(身体部位描述2),(身体部位描述3);(人物2身体特征和服装),(身体部位描述),(身体部位描述1),(身体部位描述2),(身体部位描述3)",
    },
    "XX-XX(场景编号)":{
        "主体":"（全部人物相对位置和姿势）",
        "画面视角焦距":"(画面的视角),(画面焦距)",
        "细致描述":"(人物1名字、人物1身体特征和服装),(身体部位描述),(身体部位描述1),(身体部位描述2),(身体部位描述3);(人物2名字、人物2身体特征和服装),(身体部位描述),(身体部位描述1),(身体部位描述2),(身体部位描述3)",
    }
}
                """
    temperature = 1.1
